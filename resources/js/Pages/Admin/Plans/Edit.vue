...
const submit = () => {
    ...
    form.features = form.features.filter(feature => feature.feature_name.trim() !== "");
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-6">
                            <h1 class="text-3xl font-bold text-gray-900">Edit Plan: {{ plan.name }}</h1>
                            <Link
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div v-for="(feature, index) in form.features" :key="index" class="border border-gray-200 rounded-lg p-4 mb-4">
                                    <div class="flex justify-between items-start mb-3">
                                        <h4 class="text-sm font-medium text-gray-700">Feature {{ index + 1 }}</h4>
                                        <button
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label :for="`feature_name_${index}`" class="block text-sm font-medium text-gray-700">
                                                Feature Name
                                            </label>
                                            <input
                                        ...
                                        <div>
                                            <label :for="`feature_description_${index}`" class="block text-sm font-medium text-gray-700">
